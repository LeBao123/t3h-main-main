                            ...
                            <div className="col-lg-8 posts-list">
                                <div className="single-post">
                                    <div className="feature-img">
                                        <img className="img-fluid" src="assets/img/blog/single_blog_1.png" alt="" /><noscript><img className="img-fluid"
                                            src="assets/img/blog/single_blog_1.png" alt="" /></noscript>
                                    </div>
                                    ...
                                    <div className="navigation-area">
                                        <div className="row">
                                            <div
                                                ...
                                                <div className="thumb">
                                                    <a href="#">
                                                        ...
                                                        <noscript><img className="img-fluid"
                                                            src="assets/img/post/preview.png" alt="" /></noscript>
                                                    </a>
                                                </div>
                                                <div className="arrow">
                                                    <a href="#">
                                            ...
                                            <div
                                                ...
                                                <div className="thumb">
                                                    <a href="#">
                                                        <img className="img-fluid" src="assets/img/post/next.png" alt="" /><noscript><img className="img-fluid"
                                                            src="assets/img/post/next.png" alt="" /></noscript>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="blog-author">
                                    <div className="media align-items-center">
                                        ...
                                        <noscript><img src="assets/img/blog/author.png" alt="" /></noscript>
                                ...
                                <div className="comments-area">
                                    ...
                                    <div className="comment-list">
                                        <div className="single-comment justify-content-between d-flex">
                                            <div className="user justify-content-between d-flex">
                                                <div className="thumb">
                                                    <img src="assets/img/comment/comment_1.png" alt="" /><noscript><img src="assets/img/comment/comment_1.png"
                                                        alt="" /></noscript>
                                                </div>
                                                <div className="desc">
                                                    <p className="comment">
                                    ...
                                    <div className="comment-list">
                                        <div className="single-comment justify-content-between d-flex">
                                            <div className="user justify-content-between d-flex">
                                                <div className="thumb">
                                                    <img src="assets/img/comment/comment_2.png" alt="" /><noscript><img src="assets/img/comment/comment_2.png"
                                                        alt="" /></noscript>
                                                </div>
                                                <div className="desc">
                                                    <p className="comment">
                                    ...
                                    <div className="comment-list">
                                        <div className="single-comment justify-content-between d-flex">
                                            <div className="user justify-content-between d-flex">
                                                <div className="thumb">
                                                    <img src="assets/img/comment/comment_3.png" alt="" /><noscript><img src="assets/img/comment/comment_3.png"
                                                        alt="" /></noscript>
                                                </div>
                                                <div className="desc">
                                                    <p className="comment">
                                ...
                                <div className="blog_right_sidebar">
                                    ...
                                    <aside className="single_sidebar_widget popular_post_widget">
                                        ...
                                        <div className="media post_item">
                                            ...
                                            <noscript><img src="assets/img/post/post_1.png" alt="post" /></noscript>
                                            <div className="media-body">
                                        ...
                                        <div className="media post_item">
                                            ...
                                            <noscript><img src="assets/img/post/post_2.png" alt="post" /></noscript>
                                            <div className="media-body">
                                                <a href="single-blog.html">
                                        ...
                                        <div className="media post_item">
                                            ...
                                            <noscript><img src="assets/img/post/post_3.png" alt="post" /></noscript>
                                            <div className="media-body">
                                                <a href="single-blog.html">
                                        ...
                                        <div className="media post_item">
                                            ...
                                            <noscript><img src="assets/img/post/post_4.png" alt="post" /></noscript>
                                            <div className="media-body">
                                                <a href="single-blog.html">
                                        ...
                                        <ul className="instagram_row flex-wrap">
                                            <li>
                                                <a href="#">
                                                    ...
                                                    <noscript><img className="img-fluid" src="assets/img/post/post_5.png" alt="" /></noscript>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <img className="img-fluid" src="assets/img/post/post_6.png" alt=""  />
                                                    <noscript><img className="img-fluid" src="assets/img/post/post_6.png" alt="" /></noscript>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <img className="img-fluid" src="assets/img/post/post_7.png" alt=""  />
                                                    <noscript><img className="img-fluid" src="assets/img/post/post_7.png" alt="" /></noscript>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <img className="img-fluid" src="assets/img/post/post_8.png" alt=""  />
                                                    <noscript><img className="img-fluid" src="assets/img/post/post_8.png" alt="" /></noscript>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <img className="img-fluid" src="assets/img/post/post_9.png" alt=""  />
                                                    <noscript><img className="img-fluid" src="assets/img/post/post_9.png" alt="" /></noscript>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <img className="img-fluid" src="assets/img/post/post_10.png" alt=""  />
                                                    <noscript><img className="img-fluid" src="assets/img/post/post_10.png" alt="" /></noscript>
                                                </a>
                                            </li>
                                        </ul>
                                    </aside>
