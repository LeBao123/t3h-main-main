                        ...
                        <div className="section-top-border">
                            ...
                            <div className="row">
                                <div className="col-md-3">
                                    ...
                                    <noscript><img src="assets/img/elements/d.jpg" alt="" className="img-fluid"/></noscript>
                                </div>
                            ...
                            <div className="progress-table-wrap">
                                <div className="progress-table">
                                    ...
                                    <div className="table-row">
                                        ...
                                        <div className="country"> <img src="assets/img/elements/f1.jpg" alt="flag"/>
                                        <noscript><img src="assets/img/elements/f1.jpg" alt="flag"/></noscript>Canada</div>
                                        <div className="visit">645032</div>
                                        <div className="percentage">
                                            <div className="progress">
                                                <div className="progress-bar color-1" role="progressbar" style={{width: 80}} aria-valuenow="80"
                                    ...
                                    <div className="table-row">
                                        ...
                                        <div className="country"> <img src="assets/img/elements/f2.jpg" alt="flag"/>
                                        <noscript><img src="assets/img/elements/f2.jpg" alt="flag"/></noscript>Canada</div>
                                        <div className="visit">645032</div>
                                        <div className="percentage">
                                            <div className="progress">
                                                <div className="progress-bar color-2" role="progressbar" style={{width: 30}} aria-valuenow="30"
                                                    aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="table-row">
                                        ...
                                        <div className="country"> <img src="assets/img/elements/f3.jpg" alt="flag"/>
                                        <noscript><img src="assets/img/elements/f3.jpg" alt="flag"/></noscript>Canada</div>
                                        <div className="visit">645032</div>
                                        <div className="percentage">
                                            <div className="progress">
                                                <div className="progress-bar color-3" role="progressbar" style={{width: 55}} aria-valuenow="55"
                                                    aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="table-row">
                                        ...
                                        <div className="country"> <img src="assets/img/elements/f4.jpg" alt="flag"/>
                                        <noscript><img src="assets/img/elements/f4.jpg" alt="flag"/></noscript>Canada</div>
                                        <div className="visit">645032</div>
                                        <div className="percentage">
                                            <div className="progress">
                                                <div className="progress-bar color-4" role="progressbar" style={{width: 60}} aria-valuenow="60"
                                                    aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="table-row">
                                        ...
                                        <div className="country"> <img src="assets/img/elements/f5.jpg" alt="flag"/>
                                        <noscript><img src="assets/img/elements/f5.jpg" alt="flag"/></noscript>Canada</div>
                                        <div className="visit">645032</div>
                                        <div className="percentage">
                                            <div className="progress">
                                                <div className="progress-bar color-5" role="progressbar" style={{width: 40}} aria-valuenow="40"
                                                    aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="table-row">
                                        ...
                                        <div className="country"> <img src="assets/img/elements/f6.jpg" alt="flag"/>
                                        <noscript><img src="assets/img/elements/f6.jpg" alt="flag"/></noscript>Canada</div>
                                        <div className="visit">645032</div>
                                        <div className="percentage">
                                            <div className="progress">
                                                <div className="progress-bar color-6" role="progressbar" style={{width: 70}} aria-valuenow="70"
                                                    aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="table-row">
                                        ...
                                        <div className="country"> <img src="assets/img/elements/f7.jpg" alt="flag"/>
                                        <noscript><img src="assets/img/elements/f7.jpg" alt="flag"/></noscript>Canada</div>
                                        <div className="visit">645032</div>
                                        <div className="percentage">
                                            <div className="progress">
                                                <div className="progress-bar color-7" role="progressbar" style={{width: 30}} aria-valuenow="30"
                                                    aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="table-row">
                                        ...
                                        <div className="country"> <img src="assets/img/elements/f8.jpg" alt="flag"/>
                                        <noscript><img src="assets/img/elements/f8.jpg" alt="flag"/></noscript>Canada</div>
                                        <div className="visit">645032</div>
                                        <div className="percentage">
                                            <div className="progress">
                                                <div className="progress-bar color-8" role="progressbar" style={{width: 60}} aria-valuenow="60"
                                                    aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <form action="#">
                                        <div className="mt-10">
                                            <input type="text" name="first_name" placeholder="First Name" onfocus="this.placeholder = ''"
                                                onblur="this.placeholder = 'First Name'" required className="single-input"/>
                                        </div>
                                        <div className="mt-10">
                                            <input type="text" name="last_name" placeholder="Last Name" onfocus="this.placeholder = ''"
                                                onblur="this.placeholder = 'Last Name'" required className="single-input"/>
                                        </div>
                                        <div className="mt-10">
                                            <input type="text" name="last_name" placeholder="Last Name" onfocus="this.placeholder = ''"
                                                onblur="this.placeholder = 'Last Name'" required className="single-input"/>
                                        ...
                                        <div className="mt-10">
                                            <input type="email" name="EMAIL" placeholder="Email address" onfocus="this.placeholder = ''"
                                                onblur="this.placeholder = 'Email address'" required className="single-input"/>
                                        </div>
                                        ...
                                        <div className="mt-10">
                                            <input type="text" name="first_name" placeholder="Primary color" onfocus="this.placeholder = ''"
                                                onblur="this.placeholder = 'Primary color'" required className="single-input-primary"/>
                                        </div>
                                        <div className="mt-10">
                                            <input type="text" name="first_name" placeholder="Accent color" onfocus="this.placeholder = ''"
                                                onblur="this.placeholder = 'Accent color'" required className="single-input-accent"/>
                                        </div>
                                        <div className="mt-10">
                                            <input type="text" name="first_name" placeholder="Secondary color" onfocus="this.placeholder = ''"
                                                onblur="this.placeholder = 'Secondary color'" required className="single-input-secondary"/>
                                        </div>
                                    </form>
                                </div>
