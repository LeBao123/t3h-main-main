...
import { get } from "../service/product2.service";
import { getnow } from "../service/product3.services";
...
function Home(props) {
    ...
    // const [totall, setTotall] = useState(100);
    // const [skipp, setSkipp] = useState(0);
    // const [limitt, setLimitt] = useState(30);
    // const getnowData = async () => {
    //     const ts = await get(limitt, skipp);
                                ...
                                <div className="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                                    <div className="hero__caption">
                                        ...
                                        <div className="hero__btn" data-animation="fadeInLeft" data-delay=".8s" data-duration="2000ms">
                                            <NavLink to="/shop" className="btn hero-btn">Shop Now</NavLink>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                        <div className="single-new-pro mb-30 text-center">
                                            <div className="product-img">
                                                ...
                                                <noscript><img src={b.thumbnail} height="270" alt="" /></noscript>
                                            </div>
